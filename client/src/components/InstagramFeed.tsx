...
const craftPhotos = [
   ...
   { src: "/assets/craft-f1.jpeg", alt: "Quality Inspection" },
];
      ...
      <section className="py-20 bg-background">
         <div className="container mx-auto px-6 text-center">
            <div className="mb-12">
               ...
               <h2 className="text-3xl font-serif text-foreground">Follow Our Craftsmanship</h2>
               <a href="#" className="text-foreground/50 text-sm hover:text-gold transition-colors mt-2 block">@IndiaGranite</a>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
               {craftPhotos.map((photo, idx) => (
                  <div key={idx} className="aspect-square bg-white relative group overflow-hidden cursor-pointer rounded-lg shadow-sm">
