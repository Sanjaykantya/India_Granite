         ...
         <div className="container mx-auto px-6">
            <div className="text-center mb-20">
               ...
               <motion.h2
                  ...
                  className="text-4xl md:text-6xl font-serif text-foreground uppercase tracking-tight"
               >
                  The Art of Master <span className="text-gold italic">Polishing</span>
               </motion.h2>
               <p className="text-foreground/50 mt-6 max-w-xl mx-auto font-light leading-relaxed">
            ...
            <div
               ref={containerRef}
               className="relative w-full aspect-[21/9] max-w-7xl mx-auto rounded-2xl overflow-hidden cursor-none select-none shadow-2xl group"
               onMouseMove={(e) => handleMove(e.clientX)}
               onTouchMove={(e) => handleMove(e.touches[0].clientX)}
               onMouseDown={() => setIsDrag(true)}
               onMouseUp={() => setIsDrag(false)}
            >
               {/* Legend — overlaid directly on the photograph, stays dark/glass regardless of page theme */}
               <div className="absolute top-10 inset-x-10 z-30 flex justify-between pointer-events-none">
                  ...
                  <div className="px-6 py-2 bg-gold/90 backdrop-blur-xl border border-white/20 rounded-full">
                     <span className="text-white text-[10px] uppercase tracking-[0.3em] font-bold">Italian High Gloss</span>
                  </div>
               </div>
               ...
               >
                  {/* Handle Circle */}
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-14 h-14 bg-white/10 backdrop-blur-md border border-white/30 rounded-full flex items-center justify-center group-hover:scale-125 transition-transform duration-500 shadow-[0_0_30px_rgba(255,255,255,0.2)]">
            ...
            <div className="mt-12 flex justify-center gap-4 opacity-50 group-hover:opacity-100 transition-opacity">
               <p className="text-[10px] text-foreground uppercase tracking-[0.4em] font-light">
